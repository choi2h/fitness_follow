...
class MemberServiceTest {
    ...
    void registerMemberTest() {
        ...
        // when
        MemberInfo result = memberService.registerNewMember(request);
    ...
    void getAllMemberTest() {
        ...
        // when
        List<MemberInfo> resultList = memberService.getAllMembers();
    ...
    void getMemberListByBranchIdTest() {
        ...
        // when
        List<MemberInfo> resultList = memberService.getMembersByBranchId(1L);
